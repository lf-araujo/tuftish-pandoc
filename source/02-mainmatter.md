...
and Inspect Element frequently [@Field2012].
...
!newthought(In his later books) ^[[*Beautiful Evidence*](http://www.edwardtufte.com/tufte/books_be)], Tufte
...
use of sidenotes.^[This is a sidenote.] Sidenotes are like
...
!Rplot(rplot-test )(This is just an R plot example {width = 30%})
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
plot(pressure)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
from 1700 to 1780)(source/figures/exports-imports.png)

!marginnote(!img(Image of a Rhinoceros)(source/figures/rhino.png) F.J. Cole, “The History of
...
Russian campaign, 1812-1813)(source/figures/napoleons-march.png)
...
```
!rawinclude(style/pp-macros/tufte.pp)
```
